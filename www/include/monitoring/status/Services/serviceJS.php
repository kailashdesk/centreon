...
<script type="text/javascript">
    ...
    function send_the_command() {
        ...
        if (_cmd == '70' || _cmd == '72') {
            ...
            var start = searchElement.find('[name="alternativeDateStart"]').val() + ' ' + searchElement.find('#start_time').val();
            var end = searchElement.find('[name="alternativeDateEnd"]').val() + ' ' + searchElement.find('#end_time').val();
            var author = jQuery('#author').val();
